...
const Hero = () => {
  ...
  return (
    <section className="relative md:pt-40 md:pb-16 py-20 overflow-hidden z-1" id="main-banner">
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="grid grid-cols-12">
          <motion.div {...leftAnimation} className="lg:col-span-5 col-span-12">
            ...
            <h1 className="font-medium lg:text-44 md:text-44 text-54 lg:text-start text-center text-white mb-5 mt-24">
              Deep Learning IndabaX 2025!
              {/* <span className="text-primary">Crypto</span> of your{" "}
              <span className="text-primary">choice</span>! */}
            </h1>
            <p className="font-thin text-2xl">
              Strengthening African Machine Learning – building communities, capacity, and inclusion across Africa.
            </p>
            ...
            {/* <div className="flex items-center md:justify-start justify-center gap-12 mt-20">
              <Link href="#" className="hover:scale-110 duration-300">
                <Image src={`${getImagePrefix()}images/hero/playstore.png`} alt="Play Store" width={240} height={70} />
              </Link>
              <Link href="#" className="hover:scale-110 duration-300">
                <Image src={`${getImagePrefix()}images/hero/applestore.png`} alt="App Store" width={240} height={70} />
              </Link>
            </div> */}
          </motion.div>
          <motion.div {...rightAnimation} className="col-span-7 lg:block hidden">
            <div className="ml-32 -mr-64">
              <Image
                src={`${getImagePrefix()}images/hero/everyone.jpg`}
                alt="Banner"
                width={1150}
                height={400}
                className="h-[600px] w-auto mix-blend-overlay"
              />
            </div>
          </motion.div>
        </div>
      ...
      <div className="absolute w-50 h-50 bg-gradient-to-bl from-[#1d2c5d] from-50% to-charcoalGray to-60% blur-400 rounded-full -top-64 -right-14 -z-1"></div>
